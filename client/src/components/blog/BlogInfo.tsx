    ...
    return (
        <>
            ...
            <div className="flex items-center justify-between">
                <button onClick={handleShare} className="flex gap-2 mt-6 text-sm font-semibold text-gray-400 transition-colors cursor-pointer">
                    {copied
                ...
                <button
                    ...
                    className="flex gap-2 mt-6 text-sm font-semibold text-gray-400 transition-colors cursor-pointer"
                >
                    {saved
                        ? <><BookmarkSlashIcon className="w-5 h-5 text-blue-400"/> <span className="text-blue-400">Guardado</span></>
                        : <><BookmarkIcon className="w-5 h-5"/> Guardar</>
                    }
                </button>
            </div>
        </>
