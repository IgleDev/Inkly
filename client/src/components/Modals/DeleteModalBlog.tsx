                    ...
                    >
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-start">
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <div className="mt-2">
                                        ...
                                        <span className="font-mono text-xs sm:text-sm bg-gray-100 border border-gray-300 px-1.5 py-0.5 rounded break-all inline-block mt-2">
                                        ...
                                        <input type="text" onChange={(e) => setUserInput(e.target.value)} value={userInput}
                                            className="w-full mt-2 bg-gray-700 text-white placeholder:text-gray-500 border border-red-600 focus:ring-red-500 focus:outline-none rounded-xl p-2 font-bold text-base sm:text-lg"
                        ...
                        <div className="bg-gray-700/25 px-4 py-3 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end sm:px-6">
                            ...
                            <button type="button" onClick={() => mutate(blog._id)} disabled={!isValid}
                                className="inline-flex w-full justify-center rounded-md bg-red-500 px-3 py-2 text-sm font-semibold text-white hover:bg-red-600 sm:w-auto transition-colors disabled:bg-red-900/50 disabled:text-gray-600"
                            >
                                BORRAR
                            </button>
                        </div>
